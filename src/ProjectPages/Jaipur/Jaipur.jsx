...
const Jaipur = () => {
  return (
    <section className="jaipur">
      <div className="jaipur__text">
        <h1>jaipur</h1>
        <p className="jaipur__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="jaipur__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="jaipur__content">
        <h2>Project Overview</h2>
        <p>
          jaipur was developed as a modern approach to trivia gaming, designed
        ...
        <p>
          Built using React and TypeScript, jaipur leverages modern web
        ...
        <div className="jaipur__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building jaipur was creating an intuitive user
        ...
        <p>
          Developing jaipur significantly improved my skills in TypeScript and
