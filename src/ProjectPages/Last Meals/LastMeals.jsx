import "./LastMeals.css";

const LastMeals = () => {
  return (
    <section className="last-meals">
      <div className="last-meals__text">
        <h1>last-meals</h1>
        <p className="last-meals__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="last-meals__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="last-meals__content">
        <h2>Project Overview</h2>
        <p>
          last-meals was developed as a modern approach to trivia gaming,
        ...
        <p>
          Built using React and TypeScript, last-meals leverages modern web
        ...
        <div className="last-meals__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building last-meals was creating an intuitive
        ...
        <p>
          Developing last-meals significantly improved my skills in TypeScript
