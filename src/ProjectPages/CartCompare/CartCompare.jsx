  ...
  return (
    <section className="cart">
      <div className="cart__text">
        ...
        <div className="cart__technologies">
      ...
      <article className="cart__content">
        ...
        <p>
          cart was developed as a modern approach to trivia gaming, designed to
        ...
        <p>
          Built using React and TypeScript, cart leverages modern web
        ...
        <div className="cart__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building cart was creating an intuitive user
        ...
        <p>
          Developing cart significantly improved my skills in TypeScript and
