  ...
  return (
    <section className="river">
      <div className="river__text">
        <h1>RiverFlow</h1>
        <p className="river__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="river__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="river__content">
        <h2>Project Overview</h2>
        <p>
          river was developed as a modern approach to trivia gaming, designed to
        ...
        <p>
          Built using React and TypeScript, river leverages modern web
        ...
        <div className="river__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building river was creating an intuitive user
        ...
        <p>
          Developing river significantly improved my skills in TypeScript and
