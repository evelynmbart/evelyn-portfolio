...
const Hole = () => {
  return (
    <section className="hole">
      <div className="hole__text">
        <h1>hole</h1>
        <p className="hole__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="hole__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="hole__content">
        <h2>Project Overview</h2>
        <p>
          hole was developed as a modern approach to trivia gaming, designed to
        ...
        <p>
          Built using React and TypeScript, hole leverages modern web
        ...
        <div className="hole__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building hole was creating an intuitive user
        ...
        <p>
          Developing hole significantly improved my skills in TypeScript and
