...
const HomeCooked = () => {
  return (
    <section className="home-cooked">
      <div className="home-cooked__text">
        <h1>home-cooked</h1>
        <p className="home-cooked__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="home-cooked__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="home-cooked__content">
        <h2>Project Overview</h2>
        <p>
          home-cooked was developed as a modern approach to trivia gaming,
        ...
        <p>
          Built using React and TypeScript, home-cooked leverages modern web
        ...
        <div className="home-cooked__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building home-cooked was creating an intuitive
        ...
        <p>
          Developing home-cooked significantly improved my skills in TypeScript
