...
const Gridddle = () => {
  return (
    <section className="gridddle">
      <div className="gridddle__text">
        <h1>gridddle</h1>
        <p className="gridddle__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="gridddle__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="gridddle__content">
        <h2>Project Overview</h2>
        <p>
          gridddle was developed as a modern approach to trivia gaming, designed
        ...
        <p>
          Built using React and TypeScript, gridddle leverages modern web
        ...
        <div className="gridddle__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building gridddle was creating an intuitive user
        ...
        <p>
          Developing gridddle significantly improved my skills in TypeScript and
