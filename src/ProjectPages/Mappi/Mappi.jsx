...
const Mappi = () => {
  return (
    <section className="mappi">
      <div className="mappi__text">
        <h1>mappi</h1>
        <p className="mappi__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="mappi__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="mappi__content">
        <h2>Project Overview</h2>
        <p>
          mappi was developed as a modern approach to trivia gaming, designed to
        ...
        <p>
          Built using React and TypeScript, mappi leverages modern web
        ...
        <div className="mappi__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building mappi was creating an intuitive user
        ...
        <p>
          Developing mappi significantly improved my skills in TypeScript and
