...
const Farkle = () => {
  return (
    <section className="farkle">
      <div className="farkle__text">
        <h1>farkle</h1>
        <p className="farkle__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="farkle__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="farkle__content">
        <h2>Project Overview</h2>
        <p>
          farkle was developed as a modern approach to trivia gaming, designed
        ...
        <p>
          Built using React and TypeScript, farkle leverages modern web
        ...
        <div className="farkle__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building farkle was creating an intuitive user
        ...
        <p>
          Developing farkle significantly improved my skills in TypeScript and
