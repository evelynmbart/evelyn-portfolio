...
const MarkIt = () => {
  return (
    <section className="mark-it">
      <div className="mark-it__text">
        <h1>mark-it</h1>
        <p className="mark-it__description">
          A quiz/trivia app built to test and sharpen your trivia skills
        </p>
        <div className="mark-it__technologies">
          <span>TypeScript</span>
          <span>React</span>
        </div>
      </div>

      <article className="mark-it__content">
        <h2>Project Overview</h2>
        <p>
          mark-it was developed as a modern approach to trivia gaming, designed
        ...
        <p>
          Built using React and TypeScript, mark-it leverages modern web
        ...
        <div className="mark-it__image-placeholder">
          {/* Image 2 will go here */}
        </div>

        <h2>Development Challenges</h2>
        <p>
          The main challenge in building mark-it was creating an intuitive user
        ...
        <p>
          Developing mark-it significantly improved my skills in TypeScript and
